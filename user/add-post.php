    ...
    if(isset($_SESSION["username"])) {
        if(isset($_POST)) {
            if(!empty($_POST['title']) && !empty($_POST['body'])) {
                ...
                $id = $_SESSION["id"];
                $result = $db->prepare("INSERT INTO post(title, body, user_id) VALUES(?, ?, ?)");
...
<body>
    ...
    <?php include '../inc/Dashboard-header.php' ?>
        ...
        <div class="container pt-5">
            <h2 class="text-center pb-3">Add Post</h2>
            <?php if($msgErr !== ''): ?>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" placeholder="Post Body..." id="body" style="height: 100px" name="body"></textarea>
